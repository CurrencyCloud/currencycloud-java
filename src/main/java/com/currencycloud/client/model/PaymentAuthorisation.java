...
public class PaymentAuthorisation implements Entity {
	...
	public String toString() {
		return new JSONObject().appendField("id", id).appendField("paymentStatus", paymentStatus)
				.appendField("updated", updated).appendField("authStepsTaken", authStepsTaken)
				.appendField("authStepsRequired", authStepsRequired).appendField("shortReference", shortReference)
				.toString();
	}
